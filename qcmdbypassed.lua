...
local discordInvite = "Prefix is ; try ;cmds"
...
local function createNotification()
	...
	label.Text = "You Have Owner Admin"
	...
	button.MouseButton1Click:Connect(function()
		...
		button.Text = "Closing Wait..."
		task.delay(99, function()
			button.Text = "Alr, Got it!"
		end)
	end)
...
local flySpeed = 50
local UGCVS = game:GetService("UserInputService")
...
local discordInvite = "Click Ş Or use chat to use commands for list try ;cmds prefix ;"-- same goes for this link, but i'd prefer if you keep it as quirky ;)
...
local scrollText = "QuirkyCMD made by Cynatica | type cmds for a list of commands | "
